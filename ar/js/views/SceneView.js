...
class SceneView {
    constructor(containerId, model) {
        ...
        //Other UI elements
        this.overlayPanel = document.getElementById('overlayPanel');
        this.openButton = document.getElementById('openButton');
        this.closeButton = document.getElementById('closeButton');
        this.startSimulationButton = document.getElementById('startSimulation');
        this.stopSimulationButton = document.getElementById('stopSimulation');
        ...
        //AR
        this.startARCoreButton = document.getElementById("start-ar-core-button");
        this.setButton = document.getElementById("set-button");
        this.removeButton = document.getElementById("remove-button");
    }

    render() {
        this.model.render.render(this.model.scene, this.model.camera);
    }
